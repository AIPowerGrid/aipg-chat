    ...
    <Section padding={2}>
      <IllustrationContent
        ...
        description={markdown(
          `This deployment runs AI Power Grid Lite, which has no vector database — connectors and document indexing are disabled, and nothing is indexed. To connect data sources and index documents, deploy AI Power Grid in **Standard mode**. See the [deployment guide](${DEPLOYMENT_DOCS_URL}) to get started.`
        )}
      />
    </Section>
  );
