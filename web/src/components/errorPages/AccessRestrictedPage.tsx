  ...
  const initialModalMessage = isSeatLimitExceeded
    ...
    : showRenewalMessage
      ? NEXT_PUBLIC_CLOUD_ENABLED
        ? "Your access to AI Power Grid has been temporarily suspended due to a lapse in your subscription."
        : "Your access to AI Power Grid has been temporarily suspended due to a lapse in your license."
      : "An Enterprise license is required to use AI Power Grid. Your data is protected and will be available once a license is activated.";
  ...
  return (
    <ErrorPageLayout>
      ...
      {isSeatLimitExceeded ? (
        ...
        <>
          <Text text03>
            To reinstate your access and continue benefiting from AI Power Grid&apos;s
        ...
        <>
          <Text text03>
            {hadPreviousLicense
              ? "To reinstate your access and continue using AI Power Grid, please contact your system administrator to renew your license."
